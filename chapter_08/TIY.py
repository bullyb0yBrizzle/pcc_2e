...
# 8-16. Imports: Using a program you wrote that has one function 
# in it, store that function in a separate file. Import the 
# function into your main program file, and call the function 
...
import pets 
pets.describe_pet(pet_name='willie')
...
import pets as pp
pp.describe_pet(pet_name='willie')

from pizza import *
make_pizza("Large","Ham","Sallami")